...
namespace QISReader
{
    ...
    /// </summary>
    public sealed partial class VerteilungsPage3 : Page
    {
        private VerteilungsViewModel viewModel;
        public VerteilungsViewModel ViewModel { get; set; }

        private float gridHeight = 300; // aus dem Grid im Kopf zusammengerechnet: Row 2 + 3
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            viewModel.Init(true, maxNumber, gridHeight, anzahlBeschriftungAbstandnachOben, anzahlBeschriftungHeight, firstGridHeight, Resources);
        }
    }
}
